...
class GeneratePageCommand extends Command
{
    ...
    protected static $defaultName = 'generate:react:page';
    ...
    {
        $this->setDescription('Generates react page')
            ->setHelp('Eg: bin/console generate:react:page TestPage TestBundle')
            ->addArgument(self::KEY_FILE, InputArgument::REQUIRED, 'React page file')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $inputOutput->title('Generate react page');
        ...
        $fnComponentStub->setStubPath(__DIR__ .
            '/../../Resources/stub/Generate/Resources/assets/Page/SamplePage.tsx.stub');
